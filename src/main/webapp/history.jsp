...
<body>
	<div>
		...
		<a href="index.jsp">홈 | </a> <a href="history.jsp">위치
			히스토리 목록 | </a> <a href="save.jsp">OpenAPI 와이파이 정보 가져오기</a>
	...
	<table id="customers">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<button type=submit onclick="location.href='delete.jsp?id=<%=dto.getId() %>'">
					삭제</button>&nbsp;&nbsp; 
